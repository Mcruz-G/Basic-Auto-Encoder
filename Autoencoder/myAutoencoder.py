...
h1 = Dense(units = 256, activation = 'relu')(inputImg)
h2 = Dense(units = 128, activation = 'relu')(h1)
dropOut_1 = Dropout(0.3)(h2)
h3 = Dense(units = 64, activation = 'relu')(dropOut_1   )
...
decodeH3 = Dense(units = 128, activation = 'relu')(decodeH2)
decodedImg = Dense(units = 784, activation = 'sigmoid')(decodeH2)

##### Neural Network Architecture #####

# Instantiate both autoencoder and encoder using Keras Model API
